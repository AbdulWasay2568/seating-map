        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex flex-col gap-3 pt-6">
            <button
              ...
              className="w-full px-4 py-3 rounded-lg font-bold text-white text-sm uppercase tracking-widest transition-all duration-300 hover:shadow-lg cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full px-4 py-3 rounded-lg font-bold text-sm uppercase tracking-widest transition-all duration-300 border-2 border-slate-600 text-slate-300 hover:bg-slate-800 cursor-pointer"
            >
              Clear Selection
            </button>
          </div>
